...
/**
 * Created by peng.liu11 on 2019/7/4.
 */
public abstract  class BaseWbGenerator implements IGenerator{
    @Override
    public void execute(List<ClassInfo> classInfos, Map<String, Object> extParam, ZipOutputStream zipOutputStream) throws Exception {
        ...
        for (ClassInfo classInfo : classInfos) {
            ZipEntry entry = new ZipEntry(projectName + File.separator + projectName + "-vue/" + getPath(classInfo));
